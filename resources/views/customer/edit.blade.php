            ...
            <div class="row">
               <div class="col-md-6 ">
                  <div >
                     <div class="form-group"> 
                        <label>Company</label>
                        <input value="@if (old('company')!=NULL) {{old('company')}}@else <?= $user->company ?> @endif" type="text" class="form-control company" name="company" >
                     </div>
                  </div>
                    <div >
                     <div class="form-group"> 
                        <label>VAT No.</label>
                        <input value="@if (old('vat_no')!=NULL) {{old('vat_no')}}@else <?= $user->vat_number ?> @endif" type="text" class="form-control vat_no" name="vat_no" >
                     </div>
                  </div>
                  <div >
                     <div class="form-group"> 
                        <label>PhoneNO.</label>
                        <input  value="@if (old('Phone_no')!=NULL) {{old('Phone_no')}}@else <?= $user->company ?> @endif" type="text" class="form-control Phone_no" name="Phone_no" >
                     </div>
                  </div>

                        <div class="form-group">
                                  <label >Email</label>
                                  <input  value="@if (old('email')!=NULL) {{old('email')}}@else <?= $user->company ?> @endif" type="email" class="form-control email" name="email">
               ...
               <div class="col-md-6"> 
                  <div >
                     <div class="form-group"> 
                        <label>Address</label>
                        <textarea value="@if (old('address')!=NULL) {{old('address')}}@else <?= $user->company ?> @endif" type="text" class="form-control address" name="address" ></textarea>
                     </div>
                  </div>
                  <div >
                     <div class="form-group"> 
                        <label>City</label>
                        <input value="@if (old('city')!=NULL) {{old('city')}}@else <?= $user->company ?> @endif" type="text" class="form-control city" name="city" >
                     </div>
                  </div>
                  <div >
                     <div class="form-group"> 
            ...
            <div class="tab-pane" id="billing_shipping_tab">
              ...
              <hr>
                  ...
                  <div >
                     <div class="form-group"> 
                        <label>State</label>
                        <input type="text" class="form-control billing_tate" name="billing_state" >
                     </div>
                  </div>
...
@section('scripts')
 ...
 $(document).on('click','#same_customerdetails',function(events){   
     ...
     $('.billing_pin_code').val($('.pin_code').val());
